...
const handlers = {
    ...
    'ModelIntent': function () {
        const modelSlot = this.event.request.intent.slots.Model;
        let modelName = modelSlot.value.toLowerCase();
        
        let speechOutput = modelName + " selected";
        let repromptSpeech = "Can I help you with anything else?";

        const setModel = function (modelName) {
            return new Promise(function (resolve, reject) {
                var options = {
                "method": "POST",
                "hostname": "academic-dev1.cloud.thingworx.com",
                "port": null,
                "path": "/Thingworx/Things/VuforiaSDKDemo/Services/SetModel",
                "headers": {
                    "content-type": "application/json",
                    "appkey": "95ba034c-f791-4ccb-b8b4-68fe0b2ec0c8",
                    "cache-control": "no-cache",
                    "postman-token": "90a28566-580f-8646-4268-3ef77c4e56c5"
                    }
                };
...
const languageStrings = {
    ...
    'en-US': {
        translation: {
            ...
            SKILL_NAME: 'Vuforia Model Changer',
            WELCOME_MESSAGE: "Welcome to %s. What can I help you with?",
            WELCOME_REPROMT: 'For instructions on what you can say, please say help me.',
            DISPLAY_CARD_TITLE: '%s  - Recipe for %s.',
            HELP_MESSAGE: "You can ask questions such as, what\'s the recipe, or, you can say exit...Now, what can I help you with?",
            HELP_REPROMT: "You can say things like, what\'s the recipe, or you can say exit...Now, what can I help you with?",
